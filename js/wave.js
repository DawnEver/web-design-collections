var Stats = function() {
    ...
    return {
      ...
      begin: function() {
        ...
        l++,
        h > t + 1000 && (s = Math.round(1000 * l / (h - t)), o = Math.min(o, s), a = Math.max(a, s), d.textContent = s + " FPS (" + o + "-" + a + ")", b(p, Math.min(30, 30 - 30 * (s / 100))), t = h, l = 0),
        h
      },
      update: function() {
        e = this.end()
